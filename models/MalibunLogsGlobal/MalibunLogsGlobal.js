 ...
 *
 * */
MalibunLogsGlobalModel = class MalibunLogsGlobalModel extends MalibunModel{

};

MalibunLogsGlobal = new MalibunCollection('malibunLogsGlobal',{
...
MalibunLogsGlobal.schema = new SimpleSchema({
